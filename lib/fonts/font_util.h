...
// extern DBYTE display_text(const char *, DBYTE, DBYTE, DBYTE);

extern DBYTE display_text16(const char *, DBYTE, DBYTE, DBYTE);

extern DBYTE display_text32(const char *, DBYTE, DBYTE, DBYTE);

extern DBYTE display_text64(const char *, DBYTE, DBYTE, DBYTE);
